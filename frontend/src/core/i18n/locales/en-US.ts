...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦌 HyperDev, an open source super agent. With built-in and custom skills, HyperDev helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of HyperDev. With customized skills,\nHyperDev can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  // Workspace
  workspace: {
    officialWebsite: "HyperDev's official website",
    githubTooltip: "HyperDev on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "HyperDev on GitHub",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About HyperDev",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to HyperDev",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate HyperDev faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how HyperDev looks and behaves for you.",
    sections: {
    ...
    memory: {
      title: "Memory",
      description:
        "HyperDev automatically learns from your conversations in the background. These memories help HyperDev understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of HyperDev.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "HyperDev only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
